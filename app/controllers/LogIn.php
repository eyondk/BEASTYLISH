            ...
            if (!empty($email) && !empty($password)) {
                ...
                if ($customer) {
                    ...
                    if (password_verify($saltedPassword, $admin->admin_passwordhash)) {
                        ...
                        $_SESSION['admin_sex'] = $admin->admin_sex;
                        $_SESSION['admin_address'] = $admin->admin_address;
                        $_SESSION['admin_city'] = $admin->admin_city;
                        $_SESSION['admin_province'] = $admin->admin_province;
