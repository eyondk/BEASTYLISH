                    ...
                    <?php foreach ($search_results as $product): ?>
                        <div class="product-card"
                            ...
                            <div class="main-images">
                                <img class="product-img" src="../public/assets/images/<?= htmlspecialchars($product['image_path']) ?>" alt="<?= htmlspecialchars($product['prod_name']) ?>">
                            </div>
                            <div class="details">
            ...
            <div class="modal-content">
                ...
                <div class="modal-product-card">
                    ...
                    <div class="details">
                        ...
                        <span class="modal-stock" style="text-transform: uppercase; font-size: 13px; color: #6c4a21;"></span>
                    </div>
                     <!-- </div>
