...
<body>
    ...
    <div class="order-container">
        ...
        <div class="orderstatus" >
            <input type="button" name="status" value="PENDING">
            <input type="button" name="status" value="ON SHIPPED">
            <input type="button" name="status" value="ON DELIVERY">
            <input type="button" name="status" value="COMPLETED">
            <input type="button" name="status" value="CANCELLED">
        </div>            
        <div class="order">
